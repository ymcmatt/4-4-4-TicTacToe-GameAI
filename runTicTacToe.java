...
public class runTicTacToe {
	...
	static int winsfor1 = 0;
	static int winsfor2 = 0;
	public void run()
	{
		...
		while((result = isEnded())==0) //game loop
		{
			if(turn==1)
			{
				positionTicTacToe player1NextMove = ai1.myAIAlgorithm1(board,1); 
	...
	public static void main(String[] args) {		
		...
		System.out.println(winsfor1);
		System.out.println(winsfor2);
	}
}
